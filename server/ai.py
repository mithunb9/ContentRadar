...
def generate_insight(data, search_data):
    response = client.chat.completions.create(
        ...
        messages=[
            {"role":"system","content":"You are an assistant that generates insights about a topic given the original data and Google search results. Output should be in a consistent format."},
...
print(generate_insight(data, search_data))
